...
export default function OTP() {
  ...
  const handleSignUp = () => {
    let errors = {};
    if (!phoneNumber) errors.error = "Phone Number must not null";

    if (errors.error) setErrors(errors);
    else signInWithPhone();
  };
      ...
      <div className="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2">
        {status == "NOT_INPUT_NUMBER" ? (
          <>
            ...
            <div className="mb-4">
              <label htmlFor="phoneNumber" className="block text-gray-600">
                Please enter the Phone Number that we can use to send the OTP
              </label>
              <input
                type="tel"
                id="phoneNumber"
          ...
          <>
            ...
            <div className="mb-4">
              <label htmlFor="phoneNumber" className="block text-gray-600">
                Please enter the OTP that we send to this phone number
              </label>
              <input
                type="tel"
                id="phoneNumber"
            ...
            {/* <!-- Forgot Password Link --> */}
            <div className="text-blue-500 py-2">
              <p className="hover:underline" onClick={sendingCode}>
        ...
        {/* <!-- Error --> */}
        <div className="text-red-500 py-2">
          <p href="/" className="hover:underline text-red-500">
            {errors.error}
          </p>
        </div>
        ...
        {/* <!-- Alert --> */}
        <div className="text-red-500 py-2">
          <p href="/" className="hover:underline text-green-400">
            {alerts.alert}
          </p>
        </div>
      </div>
